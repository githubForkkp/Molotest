...
public class DESedeCoder extends EncryptionAdapter {
	
	public static final byte[] initKey = {0x11, 0x22, 0x4F, 0x58, (byte) 0x88, 0x10,
										0x40, 0x38, 0x28, 0x25, 0x79, 0x51, (byte) 0xCB, (byte) 0xDD,
										0x55, 0x66, 0x77, 0x29, 0x74, (byte) 0x98, 0x30, 0x40, 0x36,
										(byte) 0xE2 };
	
	public static final byte[] initKeyFroTwc = StringUtil.getUTF8Bytes("TencentMolo&&##%%!!!1234");
	...
	public static byte[] initKey() throws Exception {
		...
		final byte[] keyBtyesForHaina = "@!@(*&^%%^**^^<>?><)zxcv".getBytes();

		return keyBtyesForHaina;
	}

...
public final class AppDetail extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    {
        return "com.qq.jce.ws.AppDetail";
    }
    ...
    public com.qq.jce.ws.RatingInfo appRating = null;

    public com.qq.jce.ws.RatingInfo apkRating = null;
    ...
    public java.util.ArrayList<com.qq.jce.ws.SnapshotsPic> snapshotsUrl = null;

    public java.util.ArrayList<com.qq.jce.ws.Video> videoList = null;
    ...
    public com.qq.jce.ws.RatingInfo getAppRating()
    {
        return appRating;
    }

    public void  setAppRating(com.qq.jce.ws.RatingInfo appRating)
    {
        this.appRating = appRating;
    }

    public com.qq.jce.ws.RatingInfo getApkRating()
    {
        return apkRating;
    }

    public void  setApkRating(com.qq.jce.ws.RatingInfo apkRating)
    {
    ...
    public java.util.ArrayList<com.qq.jce.ws.SnapshotsPic> getSnapshotsUrl()
    {
        return snapshotsUrl;
    }

    public void  setSnapshotsUrl(java.util.ArrayList<com.qq.jce.ws.SnapshotsPic> snapshotsUrl)
    {
        this.snapshotsUrl = snapshotsUrl;
    }

    public java.util.ArrayList<com.qq.jce.ws.Video> getVideoList()
    {
        return videoList;
    }

    public void  setVideoList(java.util.ArrayList<com.qq.jce.ws.Video> videoList)
    {
    ...
    public long getAppDownCountPure()
    {
        return appDownCountPure;
    }

    public void  setAppDownCountPure(long appDownCountPure)
    {
        this.appDownCountPure = appDownCountPure;
    }
    ...
    public void  setAppPublishTime(int appPublishTime)
    {
    ...
    public AppDetail(String pkgName, String appName, String iconUrl, String apkUrl, long fileSize, int versionCode, String versionName, long appDownCount, com.qq.jce.ws.RatingInfo appRating, com.qq.jce.ws.RatingInfo apkRating, long flag, int minSdkVersion, long appId, String description, String newFeature, java.util.ArrayList<String> permissions, String editorIntro, java.util.ArrayList<com.qq.jce.ws.SnapshotsPic> snapshotsUrl, java.util.ArrayList<com.qq.jce.ws.Video> videoList, long apkId, long authorId, String authorName, long apkPublishTime, long categoryId, String categoryName, String englishName, String signatureMd5, String apkMd5, long appDownCountPure, int checkLevel, String signatureMd5Molo, String tag, int parentCategoryID, int appPublishTime)
    {
        this.pkgName = pkgName;
        this.appName = appName;
        this.iconUrl = iconUrl;
    ...
    public boolean equals(Object o)
    {
        ...
        return (
            ...
            com.qq.taf.jce.JceUtil.equals(appDownCountPure, t.appDownCountPure) && 
            com.qq.taf.jce.JceUtil.equals(checkLevel, t.checkLevel) && 
            com.qq.taf.jce.JceUtil.equals(signatureMd5Molo, t.signatureMd5Molo) && 
            com.qq.taf.jce.JceUtil.equals(tag, t.tag) && 
            com.qq.taf.jce.JceUtil.equals(parentCategoryID, t.parentCategoryID) && 
            com.qq.taf.jce.JceUtil.equals(appPublishTime, t.appPublishTime) );
    }
    ...
    public void writeTo(com.qq.taf.jce.JceOutputStream _os)
    {
        ...
        _os.write(appDownCountPure, 28);
        _os.write(checkLevel, 29);
        if (null != signatureMd5Molo)
        {
            _os.write(signatureMd5Molo, 30);
        }
        if (null != tag)
        {
            _os.write(tag, 31);
        }
        _os.write(parentCategoryID, 32);
        _os.write(appPublishTime, 33);
    }

    static com.qq.jce.ws.RatingInfo cache_appRating;
    static com.qq.jce.ws.RatingInfo cache_apkRating;
    static java.util.ArrayList<String> cache_permissions;
    static java.util.ArrayList<com.qq.jce.ws.SnapshotsPic> cache_snapshotsUrl;
    static java.util.ArrayList<com.qq.jce.ws.Video> cache_videoList;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        {
            cache_appRating = new com.qq.jce.ws.RatingInfo();
        }
        this.appRating = (com.qq.jce.ws.RatingInfo) _is.read(cache_appRating, 8, true);
        if(null == cache_apkRating)
        {
            cache_apkRating = new com.qq.jce.ws.RatingInfo();
        }
        this.apkRating = (com.qq.jce.ws.RatingInfo) _is.read(cache_apkRating, 9, true);
        ...
        {
            cache_snapshotsUrl = new java.util.ArrayList<com.qq.jce.ws.SnapshotsPic>();
            com.qq.jce.ws.SnapshotsPic __var_4 = new com.qq.jce.ws.SnapshotsPic();
            ((java.util.ArrayList<com.qq.jce.ws.SnapshotsPic>)cache_snapshotsUrl).add(__var_4);
        }
        this.snapshotsUrl = (java.util.ArrayList<com.qq.jce.ws.SnapshotsPic>) _is.read(cache_snapshotsUrl, 17, true);
        if(null == cache_videoList)
        {
            cache_videoList = new java.util.ArrayList<com.qq.jce.ws.Video>();
            com.qq.jce.ws.Video __var_5 = new com.qq.jce.ws.Video();
            ((java.util.ArrayList<com.qq.jce.ws.Video>)cache_videoList).add(__var_5);
        }
        this.videoList = (java.util.ArrayList<com.qq.jce.ws.Video>) _is.read(cache_videoList, 18, true);
        ...
        this.apkMd5 =  _is.readString(27, false);
        this.appDownCountPure = (long) _is.read(appDownCountPure, 28, false);
        this.checkLevel = (int) _is.read(checkLevel, 29, false);
        this.signatureMd5Molo =  _is.readString(30, false);
        this.tag =  _is.readString(31, false);
        this.parentCategoryID = (int) _is.read(parentCategoryID, 32, false);
        this.appPublishTime = (int) _is.read(appPublishTime, 33, false);
    }
    ...
    public void display(java.lang.StringBuilder _os, int _level)
    {
        ...
        _ds.display(appDownCountPure, "appDownCountPure");
        _ds.display(checkLevel, "checkLevel");
        _ds.display(signatureMd5Molo, "signatureMd5Molo");
        _ds.display(tag, "tag");
        _ds.display(parentCategoryID, "parentCategoryID");
        _ds.display(appPublishTime, "appPublishTime");
    }
    ...
    public void displaySimple(java.lang.StringBuilder _os, int _level)
    {
        ...
        _ds.displaySimple(appDownCountPure, true);
        _ds.displaySimple(checkLevel, true);
        _ds.displaySimple(signatureMd5Molo, true);
        _ds.displaySimple(tag, true);
        _ds.displaySimple(parentCategoryID, true);
        _ds.displaySimple(appPublishTime, false);
    }

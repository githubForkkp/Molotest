...
public final class GetSearchSuggestRsp extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    {
        return "MAAccess.GetSearchSuggestRsp";
    }

    public String fullClassName()
    {
        return "com.qq.jce.MAAccess.GetSearchSuggestRsp";
    }
    ...
    public GetSearchSuggestRsp(int ret, java.util.ArrayList<String> keywords, java.util.ArrayList<String> pkgNameList)
    {
        this.ret = ret;
        this.keywords = keywords;
        this.pkgNameList = pkgNameList;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        if(null == cache_keywords)
        {
            ...
            String __var_25 = "";
            ((java.util.ArrayList<String>)cache_keywords).add(__var_25);
        }
        ...
        if(null == cache_pkgNameList)
        {
            ...
            String __var_26 = "";
            ((java.util.ArrayList<String>)cache_pkgNameList).add(__var_26);
        }

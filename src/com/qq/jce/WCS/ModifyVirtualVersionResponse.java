...
public final class ModifyVirtualVersionResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyVirtualVersionResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyVirtualVersionResponse";
    }
    ...
    public ModifyVirtualVersionResponse()
    {
    }

    public ModifyVirtualVersionResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyVirtualVersionResponse t = (ModifyVirtualVersionResponse) o;
        return (

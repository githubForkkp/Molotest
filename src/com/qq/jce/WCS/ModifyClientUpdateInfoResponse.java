...
public final class ModifyClientUpdateInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyClientUpdateInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyClientUpdateInfoResponse";
    }
    ...
    public ModifyClientUpdateInfoResponse()
    {
    }

    public ModifyClientUpdateInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyClientUpdateInfoResponse t = (ModifyClientUpdateInfoResponse) o;
        return (

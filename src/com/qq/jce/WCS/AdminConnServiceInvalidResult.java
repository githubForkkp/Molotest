...
public final class AdminConnServiceInvalidResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminConnServiceInvalidResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminConnServiceInvalidResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryConnServiceInvalidResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryConnServiceInvalidResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryConnServiceInvalidResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminConnServiceInvalidResult()
    {
    }

    public AdminConnServiceInvalidResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryConnServiceInvalidResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminConnServiceInvalidResult t = (AdminConnServiceInvalidResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryConnServiceInvalidResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_49 = "";
            java.util.ArrayList<String> __var_50 = new java.util.ArrayList<String>();
            String __var_51 = "";
            ((java.util.ArrayList<String>)__var_50).add(__var_51);
            cache_mapUnit.put(__var_49, __var_50);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryConnServiceInvalidResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryConnServiceInvalidResponse) _is.read(cache_stRule, 1, true);

...
public final class AdminVirtualVersionResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminVirtualVersionResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminVirtualVersionResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryVirtualVersionResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryVirtualVersionResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryVirtualVersionResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminVirtualVersionResult()
    {
    }

    public AdminVirtualVersionResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryVirtualVersionResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminVirtualVersionResult t = (AdminVirtualVersionResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryVirtualVersionResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        {
            cache_stRule = new com.qq.jce.WCS.QueryVirtualVersionResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryVirtualVersionResponse) _is.read(cache_stRule, 1, true);

...
public final class ModifyClientComponentInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyClientComponentInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyClientComponentInfoResponse";
    }
    ...
    public ModifyClientComponentInfoResponse()
    {
    }

    public ModifyClientComponentInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyClientComponentInfoResponse t = (ModifyClientComponentInfoResponse) o;
        return (

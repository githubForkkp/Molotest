...
public final class AdminClientUpdateInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminClientUpdateInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminClientUpdateInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryClientUpdateInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryClientUpdateInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryClientUpdateInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminClientUpdateInfoResult()
    {
    }

    public AdminClientUpdateInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryClientUpdateInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminClientUpdateInfoResult t = (AdminClientUpdateInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryClientUpdateInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_7 = "";
            java.util.ArrayList<String> __var_8 = new java.util.ArrayList<String>();
            String __var_9 = "";
            ((java.util.ArrayList<String>)__var_8).add(__var_9);
            cache_mapUnit.put(__var_7, __var_8);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryClientUpdateInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryClientUpdateInfoResponse) _is.read(cache_stRule, 1, true);

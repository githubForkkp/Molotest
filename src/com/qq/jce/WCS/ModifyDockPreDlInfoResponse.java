...
public final class ModifyDockPreDlInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyDockPreDlInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyDockPreDlInfoResponse";
    }
    ...
    public ModifyDockPreDlInfoResponse()
    {
    }

    public ModifyDockPreDlInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyDockPreDlInfoResponse t = (ModifyDockPreDlInfoResponse) o;
        return (

...
public final class QueryUpdateInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.QueryUpdateInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.QueryUpdateInfoResponse";
    }
    ...
    public QueryUpdateInfoResponse()
    {
    }

    public QueryUpdateInfoResponse(int eResultCode, int eUpdateType, String sUpdateVersion, String sUpdateNoteUrl, String sUpdateModule, String sDownloadUrl, String sMd5, String sInstallParam, String sRegKey, String sAlias, long lReleaseTime, long lUpdateLimit, String sRuleDesc, int nEnablePeriod)
    {
        this.eResultCode = eResultCode;
        this.eUpdateType = eUpdateType;
        this.sUpdateVersion = sUpdateVersion;
    ...
    public boolean equals(Object o)
    {
        ...
        QueryUpdateInfoResponse t = (QueryUpdateInfoResponse) o;
        return (
    ...
    public void writeTo(com.qq.taf.jce.JceOutputStream _os)
    {
        ...
        _os.write(lUpdateLimit, 11);
        if (null != sRuleDesc)
        {
            _os.write(sRuleDesc, 12);
        }
        _os.write(nEnablePeriod, 13);
    }
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        this.sInstallParam =  _is.readString(7, false);
        this.sRegKey =  _is.readString(8, false);
        this.sAlias =  _is.readString(9, false);
        this.lReleaseTime = (long) _is.read(lReleaseTime, 10, false);
        this.lUpdateLimit = (long) _is.read(lUpdateLimit, 11, false);
        this.sRuleDesc =  _is.readString(12, false);
        this.nEnablePeriod = (int) _is.read(nEnablePeriod, 13, false);
    }

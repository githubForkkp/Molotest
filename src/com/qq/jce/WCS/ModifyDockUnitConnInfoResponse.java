...
public final class ModifyDockUnitConnInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyDockUnitConnInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyDockUnitConnInfoResponse";
    }
    ...
    public ModifyDockUnitConnInfoResponse()
    {
    }

    public ModifyDockUnitConnInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyDockUnitConnInfoResponse t = (ModifyDockUnitConnInfoResponse) o;
        return (

...
public final class AdminDockPreDlInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminDockPreDlInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminDockPreDlInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryDockPreDlInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryDockPreDlInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryDockPreDlInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminDockPreDlInfoResult()
    {
    }

    public AdminDockPreDlInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryDockPreDlInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminDockPreDlInfoResult t = (AdminDockPreDlInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryDockPreDlInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_20 = "";
            java.util.ArrayList<String> __var_21 = new java.util.ArrayList<String>();
            String __var_22 = "";
            ((java.util.ArrayList<String>)__var_21).add(__var_22);
            cache_mapUnit.put(__var_20, __var_21);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryDockPreDlInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryDockPreDlInfoResponse) _is.read(cache_stRule, 1, true);

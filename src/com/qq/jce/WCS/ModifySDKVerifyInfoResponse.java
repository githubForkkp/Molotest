...
public final class ModifySDKVerifyInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifySDKVerifyInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifySDKVerifyInfoResponse";
    }
    ...
    public ModifySDKVerifyInfoResponse()
    {
    }

    public ModifySDKVerifyInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifySDKVerifyInfoResponse t = (ModifySDKVerifyInfoResponse) o;
        return (

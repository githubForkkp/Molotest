...
public final class AdminClientComponentInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminClientComponentInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminClientComponentInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryClientComponentInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryClientComponentInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryClientComponentInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminClientComponentInfoResult()
    {
    }

    public AdminClientComponentInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryClientComponentInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminClientComponentInfoResult t = (AdminClientComponentInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryClientComponentInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_19 = "";
            java.util.ArrayList<String> __var_20 = new java.util.ArrayList<String>();
            String __var_21 = "";
            ((java.util.ArrayList<String>)__var_20).add(__var_21);
            cache_mapUnit.put(__var_19, __var_20);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryClientComponentInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryClientComponentInfoResponse) _is.read(cache_stRule, 1, true);

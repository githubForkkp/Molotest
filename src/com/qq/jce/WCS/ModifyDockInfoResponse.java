...
public final class ModifyDockInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyDockInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyDockInfoResponse";
    }
    ...
    public ModifyDockInfoResponse()
    {
    }

    public ModifyDockInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyDockInfoResponse t = (ModifyDockInfoResponse) o;
        return (

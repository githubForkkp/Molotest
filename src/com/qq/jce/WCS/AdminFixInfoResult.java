...
public final class AdminFixInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminFixInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminFixInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryFixInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryFixInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryFixInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminFixInfoResult()
    {
    }

    public AdminFixInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryFixInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminFixInfoResult t = (AdminFixInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryFixInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_35 = "";
            java.util.ArrayList<String> __var_36 = new java.util.ArrayList<String>();
            String __var_37 = "";
            ((java.util.ArrayList<String>)__var_36).add(__var_37);
            cache_mapUnit.put(__var_35, __var_36);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryFixInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryFixInfoResponse) _is.read(cache_stRule, 1, true);

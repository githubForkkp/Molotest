...
public final class AdminDockUnitConnInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminDockUnitConnInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminDockUnitConnInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryDockUnitConnInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryDockUnitConnInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryDockUnitConnInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminDockUnitConnInfoResult()
    {
    }

    public AdminDockUnitConnInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryDockUnitConnInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminDockUnitConnInfoResult t = (AdminDockUnitConnInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryDockUnitConnInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_30 = "";
            java.util.ArrayList<String> __var_31 = new java.util.ArrayList<String>();
            String __var_32 = "";
            ((java.util.ArrayList<String>)__var_31).add(__var_32);
            cache_mapUnit.put(__var_30, __var_31);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryDockUnitConnInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryDockUnitConnInfoResponse) _is.read(cache_stRule, 1, true);

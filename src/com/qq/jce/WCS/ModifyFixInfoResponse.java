...
public final class ModifyFixInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyFixInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyFixInfoResponse";
    }
    ...
    public ModifyFixInfoResponse()
    {
    }

    public ModifyFixInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyFixInfoResponse t = (ModifyFixInfoResponse) o;
        return (

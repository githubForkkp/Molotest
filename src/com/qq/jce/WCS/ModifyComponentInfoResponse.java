...
public final class ModifyComponentInfoResponse extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.ModifyComponentInfoResponse";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.ModifyComponentInfoResponse";
    }
    ...
    public ModifyComponentInfoResponse()
    {
    }

    public ModifyComponentInfoResponse(int eResultCode, long uiRuleIndex)
    {
        this.eResultCode = eResultCode;
        this.uiRuleIndex = uiRuleIndex;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ModifyComponentInfoResponse t = (ModifyComponentInfoResponse) o;
        return (

...
public final class AdminUpdateInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminUpdateInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminUpdateInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryUpdateInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryUpdateInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryUpdateInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminUpdateInfoResult()
    {
    }

    public AdminUpdateInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryUpdateInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminUpdateInfoResult t = (AdminUpdateInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryUpdateInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_27 = "";
            java.util.ArrayList<String> __var_28 = new java.util.ArrayList<String>();
            String __var_29 = "";
            ((java.util.ArrayList<String>)__var_28).add(__var_29);
            cache_mapUnit.put(__var_27, __var_28);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryUpdateInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryUpdateInfoResponse) _is.read(cache_stRule, 1, true);

...
public final class AdminDockInfoResult extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    public String className()
    {
        return "WCS.AdminDockInfoResult";
    }

    public String fullClassName()
    {
        return "com.qq.jce.WCS.AdminDockInfoResult";
    }

    public java.util.Map<String, java.util.ArrayList<String>> mapUnit = null;

    public com.qq.jce.WCS.QueryDockInfoResponse stRule = null;
    ...
    public com.qq.jce.WCS.QueryDockInfoResponse getStRule()
    {
        return stRule;
    }

    public void  setStRule(com.qq.jce.WCS.QueryDockInfoResponse stRule)
    {
        this.stRule = stRule;
    }
    ...
    public AdminDockInfoResult()
    {
    }

    public AdminDockInfoResult(java.util.Map<String, java.util.ArrayList<String>> mapUnit, com.qq.jce.WCS.QueryDockInfoResponse stRule, long uiRuleIndex, int eStatus)
    {
        this.mapUnit = mapUnit;
        this.stRule = stRule;
        this.uiRuleIndex = uiRuleIndex;
    ...
    public boolean equals(Object o)
    {
        ...
        AdminDockInfoResult t = (AdminDockInfoResult) o;
        return (
    ...
    static com.qq.jce.WCS.QueryDockInfoResponse cache_stRule;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        if(null == cache_mapUnit)
        {
            ...
            String __var_9 = "";
            java.util.ArrayList<String> __var_10 = new java.util.ArrayList<String>();
            String __var_11 = "";
            ((java.util.ArrayList<String>)__var_10).add(__var_11);
            cache_mapUnit.put(__var_9, __var_10);
        }
        this.mapUnit = (java.util.Map<String, java.util.ArrayList<String>>) _is.read(cache_mapUnit, 0, true);
        if(null == cache_stRule)
        {
            cache_stRule = new com.qq.jce.WCS.QueryDockInfoResponse();
        }
        this.stRule = (com.qq.jce.WCS.QueryDockInfoResponse) _is.read(cache_stRule, 1, true);

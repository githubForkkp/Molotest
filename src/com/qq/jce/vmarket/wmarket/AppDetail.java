...
public final class AppDetail extends com.qq.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    {
        return "wmarket.AppDetail";
    }

    public String fullClassName()
    {
        return "com.qq.jce.vmarket.wmarket.AppDetail";
    }
    ...
    public com.qq.jce.vmarket.wmarket.RatingInfo appRating = null;

    public com.qq.jce.vmarket.wmarket.RatingInfo apkRating = null;
    ...
    public java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic> snapshotsUrl = null;

    public java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video> videoList = null;
    ...
    public com.qq.jce.vmarket.wmarket.RatingInfo getAppRating()
    {
        return appRating;
    }

    public void  setAppRating(com.qq.jce.vmarket.wmarket.RatingInfo appRating)
    {
        this.appRating = appRating;
    }

    public com.qq.jce.vmarket.wmarket.RatingInfo getApkRating()
    {
        return apkRating;
    }

    public void  setApkRating(com.qq.jce.vmarket.wmarket.RatingInfo apkRating)
    {
    ...
    public java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic> getSnapshotsUrl()
    {
        return snapshotsUrl;
    }

    public void  setSnapshotsUrl(java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic> snapshotsUrl)
    {
        this.snapshotsUrl = snapshotsUrl;
    }

    public java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video> getVideoList()
    {
        return videoList;
    }

    public void  setVideoList(java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video> videoList)
    {
    ...
    public AppDetail(String pkgName, String appName, String iconUrl, String apkUrl, long fileSize, int versionCode, String versionName, long appDownCount, com.qq.jce.vmarket.wmarket.RatingInfo appRating, com.qq.jce.vmarket.wmarket.RatingInfo apkRating, long flag, int minSdkVersion, long appId, String description, String newFeature, java.util.ArrayList<String> permissions, String editorIntro, java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic> snapshotsUrl, java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video> videoList, long apkId, long authorId, String authorName, long apkPublishTime, long categoryId, String categoryName, String englishName, String signatureMd5)
    {
        this.pkgName = pkgName;
        this.appName = appName;
        this.iconUrl = iconUrl;
    ...
    static com.qq.jce.vmarket.wmarket.RatingInfo cache_appRating;
    static com.qq.jce.vmarket.wmarket.RatingInfo cache_apkRating;
    static java.util.ArrayList<String> cache_permissions;
    static java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic> cache_snapshotsUrl;
    static java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video> cache_videoList;
    ...
    public void readFrom(com.qq.taf.jce.JceInputStream _is)
    {
        ...
        {
            cache_appRating = new com.qq.jce.vmarket.wmarket.RatingInfo();
        }
        this.appRating = (com.qq.jce.vmarket.wmarket.RatingInfo) _is.read(cache_appRating, 8, true);
        if(null == cache_apkRating)
        {
            cache_apkRating = new com.qq.jce.vmarket.wmarket.RatingInfo();
        }
        this.apkRating = (com.qq.jce.vmarket.wmarket.RatingInfo) _is.read(cache_apkRating, 9, true);
        ...
        {
            cache_snapshotsUrl = new java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic>();
            com.qq.jce.vmarket.wmarket.SnapshotsPic __var_4 = new com.qq.jce.vmarket.wmarket.SnapshotsPic();
            ((java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic>)cache_snapshotsUrl).add(__var_4);
        }
        this.snapshotsUrl = (java.util.ArrayList<com.qq.jce.vmarket.wmarket.SnapshotsPic>) _is.read(cache_snapshotsUrl, 17, true);
        if(null == cache_videoList)
        {
            cache_videoList = new java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video>();
            com.qq.jce.vmarket.wmarket.Video __var_5 = new com.qq.jce.vmarket.wmarket.Video();
            ((java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video>)cache_videoList).add(__var_5);
        }
        this.videoList = (java.util.ArrayList<com.qq.jce.vmarket.wmarket.Video>) _is.read(cache_videoList, 18, true);
